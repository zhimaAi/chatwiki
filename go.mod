...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.988 // indirect
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/hunyuan v1.0.988 // indirect
