  ...
  <div class="wechat-app-item">
    <div class="item-body">
      ...
      <div class="app-info">
        ...
        <div class="app-desc">{{ t('app_id_label') }}{{ item.app_id }}</div>
      </div>
    </div>
    ...
    <a-dropdown>
      <div class="btn-wrapper-box">
        <EllipsisOutlined class="zm-pointer"/>
      </div>
      <template #overlay>
        <a-menu>
...
const { t } = useI18n('views.user.official-account.components.wechat-app-item')
