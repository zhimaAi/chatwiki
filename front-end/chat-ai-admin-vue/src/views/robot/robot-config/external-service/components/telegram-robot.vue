...
<template>
  <div class="">
    <a-alert class="tip-alert zm-alert-info" type="info" show-icon>
      <template #message
        >接入后可以统一接收与回复Telegram机器人频道或群组里的客户消息，可有效提升客服的工作专注度。</template
      >
    </a-alert>
    ...
    <AddTelegramAlert ref="addAppAlertRef" @ok="onSaveSuccess" />
  </div>
</template>
...
import AddTelegramAlert from './add-telegram-alert.vue'
