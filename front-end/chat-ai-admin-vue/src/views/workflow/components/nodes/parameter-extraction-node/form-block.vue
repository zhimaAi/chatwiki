  ...
  <div class="form-block" @mousedown.stop="">
    <a-form ref="formRef" layout="vertical" :model="formState">
      <div class="gray-block">
        ...
        <a-form-item name="temperature" v-if="showMoreBtn">
          <template #label>
            ...
            <a-tooltip>
              <template #title>{{ t('msg_temperature_tooltip') }}</template>
        ...
        <a-form-item name="max_token" v-if="showMoreBtn">
          <template #label>
            ...
            <a-tooltip>
              <template #title>{{ t('msg_max_token_tooltip') }}</template>
              <QuestionCircleOutlined class="question-icon" />
            </a-tooltip>
          </template>
          <div class="number-box">
        ...
        <a-form-item name="enable_thinking" v-if="showMoreBtn && show_enable_thinking">
          <template #label>
            ...
            <a-tooltip>
              <template #title
                >{{ t('msg_deep_thinking_tooltip') }}</template
              >
              <QuestionCircleOutlined class="question-icon" />
            </a-tooltip>
          </template>
        ...
        <a-form-item name="context_pair">
          <template #label>
            ...
            <a-tooltip>
              <template #title
                >{{ t('msg_context_tooltip') }}</template
              >
              <QuestionCircleOutlined class="question-icon" />
            </a-tooltip>
          </template>
        ...
        <a-form-item name="prompt" class="width-100">
          ...
          <div class="form-tip">{{ t('msg_insert_variable') }}</div>
        </a-form-item>
      ...
      <div class="gray-block mt16">
        <div class="gray-block-title" @click="test">{{ t('label_output') }} ({{ t('label_output_field_extraction').replace('Output (', '').replace(')', '') }})</div>
...
const { t } = useI18n('views.workflow.components.nodes.parameter-extraction-node.form-block')
