  ...
  >
    <div class="options-item-tit">
      <div class="option-label">
        ...
        <a-tooltip title="同步最新的标签" v-if="item.meta?.tag_component" :overlayStyle="{ maxWidth: '600px' }" placement="top">
          <a @click="syncFieldTags && syncFieldTags(item.key, item.meta)">
            同步 <a-spin v-if="syncingTags && syncingTags[item.key]" size="small" />
          </a>
        </a-tooltip>
