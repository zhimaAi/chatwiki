...
2. [STD] AI-suggested replies now support binding workflows<br/>
3. [STD] Added default settings feature for model configuration<br/>
4. [STD] Added credits purchase entry on the pricing page<br/>
5. WebApp external service now displays "Content generated by AI" notice<br/>
6. Fixed the issue where the API returned an empty document list for regular knowledge base documents and group
   lists<br/>
