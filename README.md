...
1.普通知识库:增加分段内容标注<br/>
2.前端优化合集<br/>
3.抓取兼容js_article_content<br/>
4.相邻分段召回设置调整,支持按排序前X个分段召回相邻分段<br/>
5.【STD】登录页增加账号/手机号登录<br/>
6.【STD】新版官网调整+官网优化<br/>
7.批量学习:普通知识库批量导入文件时,自动学习<br/>
8.工作台:网页增加工作台<br/>
9.机器人统计分析支持按渠道分类统计<br/>
10.机器人:变量优化,apikey支持传递变量参数,结构化提示词支持引入变量<br/>
11.模型管理页面调整<br/>
12.公众号管理:显示账号类型和认证类型<br/>
13.【STD】知识库:触发次数统计增加权限控制,默认仅所有者可见<br/>
14.工作流未认证公众号过滤修复<br/>
15.知识库:相似问答合并<br/>
16.模型管理:模型管理支持302.AI<br/>
17.未知问题:每个未知问题需要支持查看聊天记录<br/>
