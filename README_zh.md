...
1.工作流-新增检索商品库节点<br/>
2.工作流:有会话触发器时,增加聊天测试方式<br/>
3.修复工作流聊天测试开启多模态时question未正确取文本内容问题<br/>
4.工作流代码运行:通过标准输入传递 Python 参数<br/>
5.Agent机器人思考过程显示交互优化<br/>
6.大模型调用上下文改为通过会话Id（sessionid）来取上下文<br/>
7.Agent机器人skill生成工具:DocToSkill 优化<br/>
8.Agent机器人配置:修改为默认启用execute工具<br/>
9.工作流编辑:多人编辑版本编辑锁方案优化<br/>
10.【STD】增加阿里云发送短信插件-系统插件<br/>

**2026/07/17**

1.Agent机器人支持操作停止 (适配对外服务)<br/>
2.工作流-运行测试:测试结果按节点返回<br/>
3.对外服务:支持Telegram<br/>
4.普通知识库,链接批量录入处理<br/>
5.工作流:支持调用Agent机器人节点<br/>
6.修复用户skill修改名称后没有同步问题<br/>
7.【STD】知识库分段容量和索引区分知识库和回收站<br/>
8.Agent机器人新增skill生成工具:Doc to Skill<br/>
9.【STD】sso登录- OAuth2.0<br/>
10.【STD】支持线上升级版本,续费企业版<br/>
11.工作流视频不能显示问题修复<br/>
12.【STD】修正开放接口转人工状态与重复消息<br/>
13.【STD】Agent机器人新:skill市场<br/>
14.问答知识库导入记录文档支持删除<br/>
15.Agent机器人新增skill生成工具:Web to Skill<br/>
16.【STD】sso登录- 钉钉、飞书、企业微信<br/>
17.导出工作流时清除工作流中的agent节点<br/>

**2026/07/03**

1.大模型调用时Tool Message里面传递tool_call_id<br/>
2.大模型输出 \<think>思考过程...\</think> 数据优化<br/>
3.Agent机器人支持自己上传skill功能<br/>
4.对外服务:支持通过阿里云接入WhatApp渠道<br/>
5.机器人/工作流基础配置修改时增加日志<br/>
6.AGENT优化 (精简系统提示词,内置工具支持关闭等)<br/>
7.公众号、微信客服、小程序渠道支持发送小程序卡片<br/>
8.PDF纯文本解析兼容自定义字体+清洗控制字符+康熙部首字符转换<br/>
9.新增商品库+Agent机器人支持查询商品库tool<br/>
10.Agent机器人执行脚本和命令支持配置E2B平台<br/>
