...
1.移除知识库分段时对图片的特殊处理逻辑<br/>
2.【STD】AI推荐回复-支持绑定工作流<br/>
3.【STD】添加模型配置默认设置功能<br/>
4.【STD】官网价格页面增加购买积分入口<br/>
5.webapp对外服务增加“内容由AI生成”提示<br/>
6.修复API接口普通知识库文档和分组列表返回的文档list为空问题<br/>
