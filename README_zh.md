...
1.【STD】会话记录转人工后,支持跳转小客服查看人工会话记录<br/>
2.工作流中节点名称限制最多输入20个字,扩大日志详情显示区域<br/>
3.新增加Agent类型机器人,支持调用技能<br/>
4.【STD】机器人变量支持导入小客服用户变量<br/>
5.【STD】AI推荐回复:原文模式传统模式支持设置回复数量<br/>
6.处理sql注入问题:重构数据库连接管理与SQL渲染<br/>
7.【STD】云版自有模型增加即将下线通知弹框<br/>

**2026/06/05**

1.自定义模型openrouter添加google/gemini模型报错问题修复<br/>
2.修复聊天机器人默认库添加后信息更新的数据一致性问题<br/>
3.【STD】机器人变量支持导入小客服用户变量<br/>
4.【STD】会话页面来自小客服的会话显示来源渠道和应用<br/>
5.【STD】小红书专业号客服节点增加-修改顾客信息节点<br/>
6.【STD】增加通过chatwikiadmin.xiaokefu.com.cn访问云版<br/>
7.【STD】自有模型:积分不足时大模型返回内容支持修改<br/>

**2026/05/29**

1.【STD】自定义模型>openroute模型配置代理<br/>
2.搜索模块问答命中显示效果修复<br/>
3.模型adaptor底层修改,更新claude默认模型配置<br/>
4.【STD】小红书回复私信节点支持立即回复用户信息<br/>
5.工作流菜单异常问题修复<br/>
6.【STD】小红书专业号插件-查询用户信息<br/>
7.LLM模型后方显示能力标签和积分价格<br/>
8.修复循环/批处理节点版本记录中没有存储父节点导致恢复版本丢失父节点问题<br/>
9.【STD】小红书专业号插件-回复意向评论<br/>
