...
1.【STD】账号注册不再赠送自有模型使用的积分<br/>
2.【STD】修复OpenClaw调用自有模型积分消耗异常问题<br/>
3.修复NSQ消息体超过默认大小后异常日志大量写入问题<br/>
4.添加配置参数禁用插件容器继承的父级健康检查逻辑<br/>
5.修复对外服务微信小程序被未认证的账号过滤逻辑<br/>

**2026/04/30**

1.【STD】修复导入飞书知识库时,重定向URL没有写出来,要供客户复制<br/>
2.修正函数工具的属性类型(string|number|boolean|object|array)<br/>
3.新增函数工具的属性类型未array时,追加使用items对子属性类型定义<br/>
