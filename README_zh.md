...
1.llm_request_logs增加隐式溯源标识(hash)<br/>
2.【STD】官网细节调整<br/>
3.增加模型异常管理页面支持设置备用模型<br/>
4.已接入的企微机器人支持修改ID和名称<br/>
5.机器人设置详情页面交互细节优化,多语言设置优化<br/>
6.聊天测试、嵌入网站插件底部增加提示:内容由AI生成,仅供参考<br/>
7.Agent机器人思考过程交互优化<br/>
