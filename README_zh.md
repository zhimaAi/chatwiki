...
1.【STD】云版转人工设置-用户意图转人工支持自定义识别条件<br/>
2.【STD】云版增加积分使用统计<br/>
3.【STD】修复转人工关键词统计触发次数没有根据筛选的时间变化<br/>
4.【STD】云版VIP体系:增加旗舰版<br/>
5.系统安全优化:插件下载地址改为服务端获取<br/>
6.【STD】云版免费版限制工作流调用次数<br/>
7.工作流-http请求节点:超时时长调整<br/>
8.【STD】修复自有模型统计相关模型名入库错误<br/>
9.知识库召回测试内,浏览器记住输入的内容+页面优化<br/>

**2026/09/04**

1.【STD】问答知识库回收站增加一键清空<br/>
2.参考阿里云修改对外服务页面效果 (PC+H5)<br/>
3.添加敏感词的敏感词上限放到2万<br/>
4.修复embedding部分场景Context未传递问题<br/>

**2026/08/28**

1.商品库支持添加商品卡片,支持回复商品卡片<br/>
2.更新默认输出描述移除小程序卡片说明<br/>
3.修复微信客服应用知识库内的小程序卡片无法正常回复<br/>
4.【STD】修复管理后台点击右上角账户,提示未找到可用的SSO配置<br/>
5.调用大模型服务重构<br/>
