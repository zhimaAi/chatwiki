...
1.【STD】工作流机器人:新增小红书查询物料节点<br/>
2.工作流:运行日志中增加深度思考的日志内容<br/>
3.工作流机器人:增加欢迎语等基础配置<br/>
4.【STD】AI员工显示模板,支持关联模板快速新建机器人<br/>

**2026/05/15**

1.【STD】工作流触发器:新增小红书触发器(收到小红书推送后触发)<br/>
2.修复在线数据和本地html文档图片url没有文件后缀导致分段失败问题<br/>
3.【STD】新增插件:小红书插件-回复用户私信节点<br/>
4.【STD】模板广场支持上传聊天机器人模板<br/>
5.【STD】自有模型:新增按输入token阶梯计算消耗的积分<br/>
6.修复阿里百炼嵌入模型的维度及token统计错误<br/>
7.修复统计表model实例化错误调用的BUG<br/>
8.修复统计表并发写入token统计时的竞态条件<br/>
9.用户问题建议支持自定义提示词或者选择工作流<br/>
