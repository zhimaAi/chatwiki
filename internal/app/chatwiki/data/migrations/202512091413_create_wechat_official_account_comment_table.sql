...
(
    ...
    "comment_rule_id"        INT4                                        NOT NULL DEFAULT 0,
    "user_comment_id"        INT4                                        NOT NULL DEFAULT 0,
...
CREATE INDEX "wechat_official_comment_list_access_msg_comment_index" ON "public"."wechat_official_comment_list" USING btree (
    ...
    "user_comment_id" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE UNIQUE INDEX "wechat_official_comment_list_admin_msg_comment_id" ON "public"."wechat_official_comment_list" USING btree ( "admin_user_id" "pg_catalog"."int4_ops" ASC NULLS LAST, "msg_data_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST, "user_comment_id" "pg_catalog"."int4_ops" ASC NULLS LAST );
