...
(
    ...
    "res_total"              INT4                                        NOT NULL DEFAULT 0,
    "res_succ"               INT4                                        NOT NULL DEFAULT 0,
    "res_err"                INT4                                        NOT NULL DEFAULT 0,
    "msg_data_id"            VARCHAR(50) COLLATE "pg_catalog"."default"  NOT NULL DEFAULT '' :: CHARACTER VARYING,
    "send_status"            INT2                                        NOT NULL DEFAULT 0,
    "common_total"           INT4                                        NOT NULL DEFAULT 0,
    ...
    "max_comment_id"         INT4                                        NOT NULL DEFAULT 0,
