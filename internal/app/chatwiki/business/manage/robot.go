...
func SaveRobot(c *gin.Context) {
	...
	maxToken := cast.ToInt(c.DefaultPostForm(`max_token`, `4080`))
	contextPair := cast.ToInt(c.DefaultPostForm(`context_pair`, `1`))
	...
	if !tool.InArrayString(useModel, modelInfo.LlmModelList) {
