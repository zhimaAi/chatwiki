...
func (a *Application) getReceiveInfo(push *define.PushMessage) (receiveIdType string, receiveId string) {
...
func (a *Application) getTextBaseContent(push *define.PushMessage) string {
	// 客户发送的数据
	replyContent := ""
